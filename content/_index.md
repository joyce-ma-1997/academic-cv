...
sections:
  - block: resume-biography-3
    content:
      ...
      button:
        text: Download CV
        url: uploads/Joyce_Academic_CV.pdf
      headings:
        about: 'About Me'
        education: ''
        interests: ''
    design:
      # Translucent blue gradient and softly blurred background shapes.
      background:
        gradient_mesh:
          enable: true
          style: orbs
      ...
      avatar:
        width: 260 # Full portrait width; height follows the photo's proportions.
        size: medium # Options: small (150px), medium (200px, default), large (320px), xl (400px), xxl (500px)
        shape: square # Options: circle (default), square, rounded
  # Archived homepage sections — uncomment to restore.
#   - block: markdown
#     content:
#       title: '📚 My Research'
#       subtitle: ''
